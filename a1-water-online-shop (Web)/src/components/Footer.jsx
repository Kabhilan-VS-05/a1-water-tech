      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white tracking-tight">{settings.name}</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-semibold mb-4">Services First</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/bookings" className="hover:text-white transition-colors">Book Technician Visit</Link></li>
              ...
              <li><Link to="/shop" className="hover:text-white transition-colors">Browse Products</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>{settings.addressLine1}<br />{settings.addressLine2}<br />{settings.addressLine3}</span>
              </li>
              ...
              <li className="text-slate-400">GSTIN: {settings.gstin}</li>
              <li className="flex items-center gap-3">
